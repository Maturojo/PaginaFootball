...
export default function Navbar() {
  ...
  return (
    <nav className={`sticky top-0 z-50 border-b transition-all duration-300 ${scrolled ? 'bg-primary text-white shadow-lg border-accent/20' : 'bg-transparent text-white border-transparent'}`} style={!scrolled ? { textShadow: '0 1px 4px rgba(0,0,0,0.8)' } : {}}>
